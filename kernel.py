...
# ### Take-Away
#
# * Our baseline model seemed to learn something even if this something does not look very nice. Instead of predicting 0.5 probability of each target class if yields almost the fraction of the number of one-hot-targets devided by the number of samples. Taking a look at the standard deviation we can see that all samples have nearly the same predicted values. There is no deviation, no difference between them. This is of course very bad! :-(
#
